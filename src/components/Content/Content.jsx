        ...
        <section className="inicio" id="inicio">
            ...
            <div className="titulo">
                ...
                <h1 data-aos="fade-up" data-aos-delay="800">
                    <FormattedMessage
                        id='name'
                        defaultMessage='I am Milton Diaz'
                    />
                </h1>
                ...
                <div className="redes-sociales">
                    ...
                    <a href="https://github.com/allisonjuliana" target="_blank" rel="noopener noreferrer" data-aos="fade-up" data-aos-delay="1400"><i className="fab fa-github"></i></a>
                ...
                <div className="wrapper">
                    ...
                    <a className="button" href="https://github.com/allisonjuliana" target="_blank" rel="noopener noreferrer" data-aos="fade-up" data-aos-delay="1400">
                        <div className="icon">
