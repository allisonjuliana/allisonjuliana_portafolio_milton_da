...
import cv from '../../cv/MiltonDiaz.pdf';
        ...
        <div className="row container">
            <div className="columns" data-aos="fade-right" data-aos-delay="300">
                ...
                <h4>
                    <FormattedMessage
                        id='description'
                        defaultMessage='My name is Milton Diaz and I am a full stack developer.'
                    />
                </h4>
                <p>
                    <FormattedMessage
                    ...
                    <li>
                        <p>
                            <span>
                                ...
                                Football and Programming
                        </p>
                    </li>
                    <li>
                        <p><span>Email:</span> milton_100277@hotmail.com</p>
                    </li>
                    <li>
                        <p>
                            <span>
                ...
                <div className="mas-info">
                    <a href={cv} target="_blank" rel="noopener noreferrer" download="MiltonDiaz.pdf" className="btn-codigo buttonDownload">
                        <FormattedMessage
                            id='btn-cv'
